...
var url = "https://www.yahoo.com/news/";
...
$(".article").each(function(i, element) {
        var title = $(element).find('.picture').find("h3").attr("title");
        var imgLink = $(element).find('.picture').find("h3").find("img").attr("src");
        var storyLink = $(element).find(".post-info").find("h3").attr("href");
        var summary = $(element).find(".post-info").find("h3").text();
